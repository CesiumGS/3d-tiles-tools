...
// Somewhere in the following 6000 lines of auto-generated code,
// it complains about a missing "fetch" function. So here it is:
const fs = require("fs");
const fetch = function(wasmBinaryFile) {
  const response = new Response(fs.createReadStream(wasmBinaryFile), {
